        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-8"><br><br>
                <div class="card" style="border-color: #337ab7;">
                    <h5 class="card-header text-white text-center" style="background: #337ab7;">Aptos para Tercera Dosis</h5>
                    <div class="card-body">
                        <form name="f0" action="results_3_dosis.php" method="post" class="_form_gestante">
                            <div class="row">
                                <div class="col-md">
