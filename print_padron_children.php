    ...
    if(isset($_POST["exportarCSV"])) {
        ...
        if($red_1 == 4 and $dist_1 == 'TODOS' and $establecimiento == 'TODOS'){
            $resultado = "SELECT NOMBRE_PROV, NOMBRE_DIST, NOMBRE_CENTRO_POBLA, AREA_CENTRO_POBLA, MENOR_VISITADO, MENOR_ENCONTRADO, FECHA_VISITA, FUENTE_DATOS, FECHA_FUENTE_DATOS,
                            ...
                            WHERE MES='202110' AND MONTH(DATEADD(DAY,180,FECHA_NACIMIENTO_NINO))='$mes' AND  YEAR(DATEADD(DAY,180,FECHA_NACIMIENTO_NINO))='2021'
            ...
            $resultado = "SELECT NOMBRE_PROV, NOMBRE_DIST, NOMBRE_CENTRO_POBLA, AREA_CENTRO_POBLA, MENOR_VISITADO, MENOR_ENCONTRADO, FECHA_VISITA, FUENTE_DATOS, FECHA_FUENTE_DATOS,
                            ...
                            ENTIDAD, TIPO_REGISTRO
                            FROM NOMINAL_PADRON_NOMINAL
                            WHERE MES='202110' AND MONTH(DATEADD(DAY,180,FECHA_NACIMIENTO_NINO))='$mes' AND  YEAR(DATEADD(DAY,180,FECHA_NACIMIENTO_NINO))='2021' AND NOMBRE_PROV='$red'
                            ORDER BY NOMBRE_PROV, NOMBRE_DIST";
        }
