<?php 
    ...
    $resultadoss5 = "SELECT T.Anio,Provincia_Establecimiento AS PROVINCIA, Distrito_Establecimiento AS Distrito,
                    ...
                    where (Anio IN ('2021')) and (mes in ('1','2','3','4','5','6','7','8')) AND Distrito_Establecimiento='$dist'
                    GROUP BY
    ...
    while ($consulta = sqlsrv_fetch_array($consulta5)){
        $a = $consulta['BCG_24_HORAS'];
        $b = $consulta['HVB_12_HORAS'];
        $c = $consulta['IPV_02_04_MESES_2_DOSIS'];
        $d = $consulta['APO_06_MESES_3ra_Dosis'];
        
        $result = $consulta['BCG_24_HORAS'] . ', ' . $consulta['HVB_12_HORAS'] . ', ' . $consulta['IPV_02_04_MESES_2_DOSIS'] . ', ' . $consulta['APO_06_MESES_3ra_Dosis'] . ', ' . $consulta['PENTAVALENTE_02_04_06_MESES_3ra_dosis'] . ', ' . $consulta['Reacciones_Adversas_pentavalente_DTP_3ra_dosis'] . ', ' . $consulta['Reacciones_Adversas_pentavalente_HvB_3ra_dosis'] . ', ' . $consulta['Reacciones_Adversas_pentavalente_HiB_3ra_dosis'] . ', ' . $consulta['ROTAVIRUS_02_04_MESES_2da_DOSIS'] . ', ' . 
                    $consulta['NEUMOCOCO_02_04_MESES_2da_DOSIS'] . ', '. $consulta['INFLUENZA_2da_DOSIS'] . ', ' . $consulta['NEUMOCOCO_1_ANIO_3ra_DOSIS'] . ', ' . $consulta['SPR_1_ANIO_1ra_DOSIS'];
