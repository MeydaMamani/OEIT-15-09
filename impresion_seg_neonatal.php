        ...
        if(!empty($consulta3)){
            ...
            <table>
                <thead>
                    ...
                    <tr></tr>
                    <tr>
                        <th colspan="9" style="font-size: 15px; border: 1px solid #ddd; text-align: left;"><b>Fuente: </b> BD Padrón Nominal con Fecha <?php echo $date_modify; ?> y BD CNV con Fecha: <?php echo $monday; ?> a las 08:30 horas</th>
                    </tr>
                    <tr></tr>
                </thead>
            </table> 
