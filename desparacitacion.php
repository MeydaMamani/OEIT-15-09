...
<section class="cajaslider"><!--slider*/-->
     ...
     <br>
     <br>
    <div class="col-12 text-center mb-4"><h4>DESPARACITACIÓN</h4></div> 
      ...
      <img src="./img/fondo_formulario.png" alt="" style="position: absolute; margin-top: -24px; margin-left: -24px; z-index: 0; width: 33.75%; height: 38%;">
				<form name="f1" action="consulta_desparacitacion.php" method="post" class="___________________form_gestante" style="position: relative;">
