        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-8 p-4"><br><br>
                <div class="card" style="border-color: #337ab7;">
                    <h5 class="card-header text-white text-center" style="background: #337ab7;">Gestantes con Inicio de Tratamiento </h5>
                    <div class="card-body">
                        <form name="f1" action="resultados_gestante_tratamiento.php" method="post" class="_form_gestante">
                            <div class="row">
                                <div class="col-md">
