<?php 
    ...
    if(isset($_POST["exportarCSV"])) {
        ...
        if(!empty($consulta3)){
            $ficheroExcel="DEIT_PASCO AVANCE VACUNACIÓN TERCERA DOSIS "._date("d-m-Y", false, 'America/Lima').".xls";
...
<table>
    <thead>
        ...
        <tr></tr>
        <tr class="text-center">
            <th colspan="16" style="font-size: 28px; border: 1px solid #3A3838;">AVANCE DE VACUNAIÓN TERCERA DOSIS</th>
        </tr>
        <tr></tr>
        <tr>
