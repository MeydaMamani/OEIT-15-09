...
<div class="page-wrapper">
    <div class="container">
        <div class="text-center mt-3">
            <h3 class="mb-4">Visita Domiciliaria 6 a 11 Meses - <?php echo $nombre_mes; ?></h3>
        </div>
        ...
        <div class="col-md-12">
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade show active" id="visits" role="tabpanel" aria-labelledby="home-tab">
                    <br>
                    <div class="row">
                        <div class="col-md-6 table-responsive table_no_fed" id="visitas_cuatro_meses">
                            <h4 class="text-center m-b-4 text-primary">Niños de 6 Meses Sin Anemia</h4><br>
                            <div class="mb-3">
                                <div class="row m-2">
                                                ...
                                                <div class="align-self-center">
                                                    <h4 class="font-medium mb-3 justify-content-center d-flex">
                                                        ...
                                                        <div class="mt-3 col-md-7 text-center">
                                                            <b class="font-35 total"> <?php echo $total_visits; ?></b> <i class="mdi mdi-plus font-35 text-secondary"></i>
                                                        </div>
                                                    </h4>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-body p-1">
                                            ...
                                            <div class="justify-content-center">
                                                <div class="align-self-center">
                                                    <h4 class="font-medium mb-3 justify-content-center d-flex">
                                                        <div class="col-md-5 text-end">
                                                            <img src="./img/nurse.png" width="70" alt="">
                                                        </div>
                                                        <div class="mt-3 col-md-7 text-center">
                                                            <b class="font-35 correcto"> <?php echo $face_to_face; ?></b> <i class="mdi mdi-check font-35 text-success"></i>
                                                        </div>
                                                    </h4>
                                                </div>
                                            </div>
                                        ...
                                        <p class="card-title text-secondary text-center font-18 pt-3">Teleorientación</h4>
                                            <div class="justify-content-center">
                                                <div class="align-self-center">
                                                    <h4 class="font-medium mb-3 justify-content-center d-flex">
                                                        <div class="col-md-5 text-end">
                                                            <img src="./img/online.png" width="70" alt="">
                                                        </div>
                                                        <div class="mt-3 col-md-7 text-center">
                                                            <b class="font-35 incorrecto"> <?php echo $telemonitoring; ?></b> <i class="mdi mdi-close font-35 text-danger"></i>
                                                        </div>
                                                    </h4>
                                                </div>
                                            </div>
                            ...
                            <table id="demo-foo-addrow" class="table table-hover" data-page-size="20" data-limit-navigation="10">
                                ...
                                <div class="float-end pb-1 col-md-5 table_no_fed">
                                    <div class="mb-3">
                        ...
                        <div class="col-md-6 table-responsive table_no_fed" id="visitas_cuatro_meses">
                            <h4 class="text-center m-b-4 text-danger">Niños de 6 Meses Con Anemia</h4><br>
                            <div class="mb-3">
                                <div class="row m-2">
                                    <div class="card col-md-4 datos_avance">
                                        <div class="card-body p-1">
                                            ...
                                            <div class="justify-content-center">
                                                <div class="align-self-center">
                                                    <h4 class="font-medium mb-3 justify-content-center d-flex">
                                                        ...
                                                        <div class="mt-3 col-md-7 text-center">
                                                            <b class="font-35 total"> <?php echo $total_visits_x; ?></b> <i class="mdi mdi-plus font-35 text-secondary"></i>
                                                        </div>
                                                    </h4>
                                                </div>
                                            </div>
                                            ...
                                            <div class="justify-content-center">
                                                <div class="align-self-center">
                                                    <h4 class="font-medium mb-3 justify-content-center d-flex">
                                                        ...
                                                        <div class="mt-3 col-md-7 text-center">
                                                            <b class="font-35 correcto"> <?php echo $face_to_face_x; ?></b> <i class="mdi mdi-check font-35 text-success"></i>
                                                        </div>
                                                    </h4>
                                                </div>
                                            </div>
                                            ...
                                            <div class="justify-content-center">
                                                <div class="align-self-center">
                                                    <h4 class="font-medium mb-3 justify-content-center d-flex">
                                                        ...
                                                        <div class="mt-3 col-md-7 text-center">
                                                            <b class="font-35 incorrecto"> <?php echo $telemonitoring_x; ?></b> <i class="mdi mdi-close font-35 text-danger"></i>
                                                        </div>
                                                    </h4>
                                                </div>
                                            </div>
                ...
                <div class="tab-pane fade" id="nominal_advance" role="tabpanel" aria-labelledby="profile-tab">
                    ...
                    <div class="row">
                        <div class="col-md-6 table-responsive table_no_fed" id="advance_cuatro_meses">
                            <h4 class="text-center m-b-4 text-primary">Niños de 6 Meses Sin Anemia</h4>
                            <br>
                        ...
                        <div class="col-md-6 table-responsive table_no_fed" id="advance_cuatro_meses">
                            <h4 class="text-center m-b-4 text-danger">Niños de 6 Meses Con Anemia</h4>
                            <br>
