    ...
    <div class="container">
        ...
        <div class="col-md-12">
            <ul class="nav nav-tabs nav-justified" id="myTab promsa" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="profile-tab promsa" data-bs-toggle="tab" data-bs-target="#revision" type="button" role="tab" aria-controls="profile" aria-selected="false"><i class="mdi mdi-chart-histogram"></i> Resumen</button>
                </li>
            </ul>
                    ...
                    <div id="visits_sin_dx">
                        ...
                        <div class="mb-3">
                            <div class="row m-2">
                                ...
                                <div class="card col-md-3 datos_avance m-r-4">
                                            ...
                                            <div class="align-self-center">
                                                <h4 class="font-medium mb-3 justify-content-center d-flex">
                                                    ...
                                                    <div class="mt-3 col-md-8 text-center">
                                                        <b class="font-55 total"> <?php echo $total_visits; ?></b> <i class="mdi mdi-plus font-55 text-secondary" style="margin-left: -10px;"></i>
                                                    </div>
                                                </h4>
                                            </div>
                                        </div>
                                        ...
                                        <div class="justify-content-center">
                                            <div class="align-self-center">
                                                <h4 class="font-medium mb-3 justify-content-center d-flex">
                                                    ...
                                                    <div class="mt-3 col-md-8 text-center">
                                                        <b class="font-55 correcto"> <?php echo $face_to_face; ?></b> <i class="mdi mdi-check font-55 text-success" style="margin-left: -10px;"></i>
                                                    </div>
                                                </h4>
                                            </div>
                                        </div>
                                        ...
                                        <div class="justify-content-center">
                                            <div class="align-self-center">
                                                <h4 class="font-medium mb-3 justify-content-center d-flex">
                                                    ...
                                                    <div class="mt-3 col-md-8 text-center">
                                                        <b class="font-55 incorrecto"> <?php echo $telemonitoring; ?></b> <i class="mdi mdi-close font-55 text-danger" style="margin-left: -10px;"></i>
                                                    </div>
                                                </h4>
                                            </div>
                                        </div>
                                        ...
                                        <div class="justify-content-center">
                                            <div class="align-self-center">
                                                <h4 class="font-medium mb-3 justify-content-center d-flex">
                                                    ...
                                                    <div class="mt-3 col-md-8 text-center">
                                                        <b class="font-55 total"> <?php echo $total_visits_x; ?></b> <i class="mdi mdi-plus font-55 text-secondary" style="margin-left: -10px;"></i>
                                                    </div>
                                                </h4>
                                            </div>
                                        </div>
                                            ...
                                            <div class="align-self-center">
                                                <h4 class="font-medium mb-3 justify-content-center d-flex">
                                                    ...
                                                    <div class="mt-3 col-md-7 text-center">
                                                        <b class="font-55 correcto"> <?php echo $face_to_face_x; ?></b> <i class="mdi mdi-check font-55 text-success" style="margin-left: -10px;"></i>
                                                    </div>
                                                </h4>
                                            </div>
                                        </div>
                                        ...
                                        <div class="justify-content-center">
                                            <div class="align-self-center">
                                                <h4 class="font-medium mb-3 justify-content-center d-flex">
                                                    ...
                                                    <div class="mt-3 col-md-7 text-center">
                                                        <b class="font-55 incorrecto"> <?php echo $telemonitoring_x; ?></b> <i class="mdi mdi-close font-55 text-danger" style="margin-left: -10px;"></i>
                                                    </div>
                                                </h4>
                                            </div>
                                        </div>
                            ...
                            <table id="demo-foo-addrow3" class="table table-hover" data-page-size="20" data-limit-navigation="10">
                                ...
                                <tbody>
                                    ...
                                    <tr class="text-center font-12">
                                        ...
                                        <td class="align-middle"><?php echo utf8_encode($newdate_8); ?></td>
                                        <td class="align-middle"><?php echo $newdate_9; ?></td>
                                        <td class="align-middle"><?php echo $newdate_10; ?></td>
                                        <td class="align-middle"><?php echo utf8_encode($newdate_11); ?></td>
                                        <td class="align-middle"><?php echo utf8_encode($newdate_12); ?></td>
                                        <td class="align-middle"><?php echo utf8_encode($newdate_13); ?></td>
                                        ...
                                        <div class="row pt-4">
                                            <div class="col-md-7 p-0 text-center">
                                                <h1 class="font-light avance mb-1 text-primary"><?php 
                                                        ...
                                                        else{ if($num_dac/$den_dac == 0){
                                                            echo '0%';
                                                        }else{
                                                            echo number_format((float)(($num_dac/$den_dac)*100), 2, '.', ''), '%'; }
                                                        }
                                                    ?>
                                                </h1>
                                        ...
                                        <div class="row pt-4">
                                            <div class="col-md-7 p-0 text-center">
                                                <h1 class="font-light avance mb-1 text-primary"><?php 
                                                        ...
                                                        else{ if($num_pasco/$den_pasco == 0){
                                                            echo '0%';
                                                        }else{
                                                            echo number_format((float)(($num_pasco/$den_pasco)*100), 2, '.', ''), '%'; }
                                                        }                                                            
                                                    ?>
                                                </h1>
                                                <h4 class="text-muted">Avance</h4></div>
                                        ...
                                        <div class="row pt-4">
                                            <div class="col-md-7 p-0 text-center">
                                                <h1 class="font-light avance mb-1 text-primary"><?php 
                                                        ...
                                                        else{ if($num_oxa/$den_oxa == 0){
                                                            echo '0%';
                                                        } else{
                                                            echo number_format((float)(($num_oxa/$den_oxa)*100), 2, '.', ''), '%'; }
                                                        }
                                                    ?>
                                                </h1>
                                                <h4 class="text-muted">Avance</h4></div>
                                        ...
                                        <div class="row pt-4">
                                            <div class="col-md-7 p-0 text-center">
                                                <h1 class="font-light avance mb-1 text-primary"><?php 
                                                        ...
                                                        else{ if($num_dac_x/$den_dac_x == 0){
                                                            echo '0%';
                                                        } else{
                                                            echo number_format((float)(($num_dac_x/$den_dac_x)*100), 2, '.', ''), '%'; }
                                                        }
                                                    ?>
                                                </h1>
                                                <h4 class="text-muted">Avance</h4></div>
                                        ...
                                        <div class="row pt-4">
                                            <div class="col-md-7 p-0 text-center">
                                                <h1 class="font-light avance mb-1 text-primary"><?php 
                                                        ...
                                                        else{ if($num_pasco_x/$den_pasco_x == 0){
                                                            echo '0%';
                                                        }else{
                                                            echo number_format((float)(($num_pasco_x/$den_pasco_x)*100), 2, '.', ''), '%'; }
                                                        }
                                                    ?>
                                                </h1>
                                                <h4 class="text-muted">Avance</h4></div>
                                        ...
                                        <div class="row pt-4">
                                            <div class="col-md-7 p-0 text-center">
                                                <h1 class="font-light avance mb-1 text-primary"><?php 
                                                        ...
                                                        else{ if($num_oxa_x/$den_dac_x == 0){
                                                            echo '0%';
                                                        } else{
                                                            echo number_format((float)(($num_oxa_x/$den_oxa_x)*100), 2, '.', ''), '%'; }
                                                        }                                                            
                                                    ?>
                                                </h1>
                                                <h4 class="text-muted">Avance</h4></div>
