        ...
        <div class="container">
                            ...
                            <div class="align-self-center">
                                <h4 class="font-medium mb-3 justify-content-center d-flex">
                                    ...
                                    <div class="mt-4 col-md-7 text-center">
                                        <b class="font-45 total text-secondary"> <?php echo $row_cnt; ?></b> <i class="mdi mdi-plus font-45 text-secondary" style="margin-left: -10px;"></i>
                                    </div>
                                </h4>
                            </div>
                        </div>
            ...
            <div class="row mb-3">
                <div class="col-lg-12 justify-content-center d-flex">
                    ...
                    <button type="submit" name="Limpiar" class="btn btn-outline-primary m-2 btn-sm" data-bs-toggle="modal" data-bs-target="#ModalResumen"><i class="fa fa-pie-chart"></i> Cuadro Resumen</button>
