...
<section class="cajaslider"><!--slider*/-->
     ...
     <br>
     <br>
    <div class="col-12 text-center mb-4"><h4>Niños de 4 meses</h4></div> 
		...
		<div class="row">
			...
			<div class="col-lg-4 col-sm-8 p-4 border border-primary"> <!--style="background-image: linear-gradient(-109deg, #d1c89b 0%, #169d98 81%);" -->
				...
				<form name="f1" action="consulta_4_meses.php" method="post" class="___________________form_gestante" style="position: relative;">
