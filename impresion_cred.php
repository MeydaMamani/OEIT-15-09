<?php 
    ...
    <table>
        <thead>
            ...
            <tr></tr>
            <tr class="text-center">
                <th colspan="24" style="font-size: 28px; border: 1px solid #3A3838;">CRED CG06 - <?php echo $nombre_mes; ?></th>
            </tr>
            <tr></tr>
            <tr>
	...
	<table class="table table-hover">
		<thead>
			<tr class="font-12 text-center" style="background: #e0ebd8;">
				...
				<th style="border: 1px solid #DDDDDD; font-size: 15px;">Primer Control</th>
				<th style="border: 1px solid #DDDDDD; font-size: 15px;">Segundo Control</th>
				<th style="border: 1px solid #DDDDDD; font-size: 15px;">Cumple</th>
				<th style="border: 1px solid #DDDDDD; font-size: 15px;">Tercer Control</th>
				<th style="border: 1px solid #DDDDDD; font-size: 15px;">Cuarto Control</th>
