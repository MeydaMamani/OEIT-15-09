    ...
    global $conex;
        ...
        if(($red_1 == 1 or $red_1 == 2 or $red_1 == 3) and $dist_1 == 'TODOS'){
          $resultado_fed = "SELECT Provincia_Establecimiento PROVINCIA,Distrito_Establecimiento DISTRITO,Nombre_Establecimiento IPRESS,
                            ...
                            Min(CASE WHEN (a.Codigo_Item in('81007','81002','82004') AND  (Codigo_Unico NOT IN ('000000979','000000980','000000981') ) AND a.Tipo_Diagnostico='D')THEN A.Fecha_Atencion ELSE NULL END)'BACTERIURIA',
