        ...
        <div class="homologation">
            ...
            <div class="row mb-3 mt-3">
                ...
                <div class="col-md-8 d-flex justify-content-end">
                    <button type="submit" name="Limpiar" class="btn btn-outline-secondary btn-sm 1btn_buscar" onclick="location.href='homologation.php';"><i class="mdi mdi-arrow-left-bold"></i> Regresar</button>
                </div>
            </div>
            <div class="row mb-3">
              <div class="d-flex">
