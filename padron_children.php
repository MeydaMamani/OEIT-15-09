        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-8 p-4"><br>
                <div class="card" style="border-color: #198754;">
                    <h5 class="card-header text-white text-center" style="background: #198754;">Padrón Niños 6 Meses</h5>
                    <div class="card-body">
                        <form name="f1" action="print_padron_children.php" method="POST" class="">
                            <div class="row">
                                <div class="col-md-6">
