...
<section class="cajaslider"><!--slider*/-->
     ...
     <br>
     <br>
    <div class="col-12 text-center mb-4"><h4>Niños de 6-8 meses</h4></div> 
		...
		<div class="row">
			...
			<div class="col-lg-4 col-sm-8 p-4 border border-primary"> <!--style="background-image: linear-gradient(-109deg, #d1c89b 0%, #169d98 81%);" -->
				<img src="./IMG/fondo_formulario.png" alt="" style="position: absolute; margin-top: -24px; margin-left: -24px; z-index: 0;">
				<form name="f1" action="consulta_6-8_meses.php" method="post" class="___________________form_gestante" style="position: relative;">
