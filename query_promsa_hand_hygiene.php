<?php 
    ...
    if (isset($_POST['Buscar'])) {
        ...
        $red_1 = $_POST['red3'];
        $dist_1 = $_POST['distrito3'];
        $establecimiento = $_POST['establecimiento3'];
        $mes = $_POST['mes3'];
        ...
        if($red_1 == 4 and $dist_1 == 'TODOS' and $establecimiento == 'TODOS'){
            ...
            $resultado2 = "SELECT a.*, count(*)Total from (
                            ...
                            where anio ='2021' AND Mes='$mes' AND Provincia_Establecimiento='$red' AND Distrito_Establecimiento='$dist' 
                                    AND Nombre_Establecimiento='$establecimiento' and codigo_item='99499.08' and tipo_diagnostico='D' and id_cita in
                            (select Id_Cita from T_CONSOLIDADO_NUEVA_TRAMA_HISMINSA
                            where anio='2021' and Codigo_Item='99401.24' and Tipo_Diagnostico='D' and Valor_Lab='RS'))a
                            group by a.Provincia_Establecimiento,a.distrito_Establecimiento, a.Nombre_Establecimiento, a.mes,a.ACTIVIDAD
                            ...
                            from T_CONSOLIDADO_NUEVA_TRAMA_HISMINSa
                            where anio ='2021' AND Mes='$mes' AND Provincia_Establecimiento='$red' AND Distrito_Establecimiento='$dist' 
                                    AND Nombre_Establecimiento='$establecimiento'  and codigo_item='C0011' and tipo_diagnostico='D' and id_cita in
                            (select Id_Cita from T_CONSOLIDADO_NUEVA_TRAMA_HISMINSA
                            where anio='2021' and Codigo_Item='99401.24' and Tipo_Diagnostico='D' and Valor_Lab='RS'))a
                            group by a.Provincia_Establecimiento,a.distrito_Establecimiento, a.Nombre_Establecimiento, a.mes,a.ACTIVIDAD";
        }
