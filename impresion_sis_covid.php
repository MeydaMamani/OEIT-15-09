<?php 
    ...
    if(isset($_POST["exportarCSV"])) {
      ...
      $consulta4 = sqlsrv_query($conn, $resultado3);
        ...
        if(!empty($consulta4)){
            $ficheroExcel="SIS_Covid_F0".date("d-m-Y").".csv";        
            ...
            echo "#;PROVINCIA;DISTRITO;TIPO_DOC;NUMERO_DOC;AP_NOM;DIRECCION;DNI;USUARIO_NOM;USUARIO_PROC;FEC_REG;FEC_SEG;FEC_ENT;CUMPLE\n";                    
            ...
            while ($consulta = sqlsrv_fetch_array($consulta4)){
                ...
                else{ echo utf8_encode['TIP_DOCO'].";"; }
               ...
               if(is_null ($consulta['USUARIO_PROC']) ){ echo ' - '.";"; }
                ...
                else{ echo $consulta['FEC_REG']-> format('d/m/y').";" ; }
