    ...
    if(isset($_POST["exportarCSV"])) {
        ...
        <table>
            <thead>
                ...
                <tr></tr>
                <tr class="text-center">
                    <th colspan="12" style="font-size: 28px; border: 1px solid #3A3838;">Tamizaje Neonatal CG03 - <?php echo $nombre_mes; ?></th>
                </tr>
                <tr></tr>
                <tr>
                    <th colspan="12" style="font-size: 15px; border: 1px solid #ddd; text-align: left;"><b>Fuente: </b> BD Padrón Nominal con Fecha <?php echo $date_modify; ?> y BD HisMinsa con Fecha: <?php echo _date("d/m/Y", false, 'America/Lima'); ?> a las 08:30 horas</th>
                </tr>
                <tr></tr>
            </thead>
        </table> 
