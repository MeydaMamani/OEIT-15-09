...
<section class="cajaslider"><!--slider*/-->
     ...
     <br>
    <center>
      <form name="f1" action="consulta_detalle_paciente.php" method="post" class="form_covid">
        <font class="letra" color="white">INGRESE NUMERO DE DNI</font>
        <br>
        <br>
        <input class="validanumericos" type="text" name="doc" id="doc" placeholder="DNI" maxlength="8">
       <br>
       <br>
       <br>
