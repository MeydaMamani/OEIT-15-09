        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-sm-8 p-4"><br><br>
                <div class="card" style="border-color: #337ab7;">
                    <h5 class="card-header text-white text-center" style="background: #337ab7;">Consulta Padrón</h5>
                    <div class="card-body">
                    <form name="f1" action="consulta_vacuna_padron.php" method="post" class="form_covid">
