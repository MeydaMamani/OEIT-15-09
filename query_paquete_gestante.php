<?php 
    ...
    if (isset($_POST['Buscar'])) {
        ...
        $resultado3 = "SELECT A.NUMERO_DOCUMENTO_PACIENTE,
                        ...
                        INTO BDHIS_MINSA.dbo.PASOS FROM T_CONSOLIDADO_NUEVA_TRAMA_HISMINSA A
        ...
        if(($red_1 == 1 or $red_1 == 2 or $red_1 == 3) and $dist_1 == 'TODOS'){
            $resultado4 = "SELECT Dpto_Madre,Prov_Madre,Dist_Madre,
                            ...
                            LEFT JOIN BDHIS_MINSA.dbo.PASOS B ON A.NU_DOC_MADRE=B.NUMERO_DOCUMENTO_PACIENTE where
                            ...
                            DROP TABLE BDHIS_MINSA.dbo.PASOS";
